...
`attestrum publish --target static --out-dir DIR` materializes the **same six
...
HF target); the three renderer failures reuse `ReadmeRender` / `CroissantInvalid` /
`VerifyHtmlBuild`.
...
flowchart TD
  ...
  subgraph write [write artifacts to out_dir]
    ...
    w3[attestrum/manifest.parquet &#40;copy&#41;]
    w4[attestrum/merkle.root &#40;copy&#41;]
    w5[attestrum/bundle.sigstore.json &#40;copy&#41;]
    w6[attestrum/verify.html &#40;rendered&#41;]
    w7[plan.extras &#40;copy each&#41;]
  end
