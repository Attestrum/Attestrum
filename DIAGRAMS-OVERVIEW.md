...
| File | Path | Purpose |
|---|---|---|
| This file | `DIAGRAMS-OVERVIEW.md` | Repo-root meta-map of all diagrams |
| Source diagrams | `docs/diagrams/{overview,sprint-1,sprint-2,sprint-3,sprint-4,sprint-5,attestations}/*.md` | The individual diagram files (linter-enforced) |
